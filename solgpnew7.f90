...
do inn=1, numNpoints      !scanning num (number of particles)
...
a0=(a0initial**(1d0/dfloat(napower))+a0step*dfloat(ia-1))**napower    ! in ho units
...
!write(*,*)'freqhyper=',omegahh
!-------bogoliubov approximations-------
call bogoliubov(a0,num,y1,orbit,brfreq)
!write(*,*) 'brfreqbog=', brfreq
!stop
...
!write(10,*) dt
!write(10,*) '$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$'
write(12,'(100e22.12)') num, a0, e0,orbit, condensefrac, densityave, rrave, Rtf, e0tf, orbittf, e0hh, rminhh, omegahh, brfreq, error,dt, dfloat(istep), depndrhh
